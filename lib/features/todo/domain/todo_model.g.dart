...
int _todoEstimateSize(
  ...
  bytesCount += 3 + object.prioritas.length * 3;
...
void _todoSerialize(
  ...
  writer.writeString(offsets[1], object.prioritas);
...
Todo _todoDeserialize(
  ...
  object.prioritas = reader.readString(offsets[1]);
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'prioritas',
        value: value,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'prioritas',
        value: '',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'prioritas',
        value: '',
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByPrioritas() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'prioritas', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByPrioritasDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'prioritas', Sort.desc);
    });
  }
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByPrioritas() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'prioritas', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByPrioritasDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'prioritas', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctByPrioritas(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'prioritas', caseSensitive: caseSensitive);
    });
  }
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, String, QQueryOperations> prioritasProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'prioritas');
    });
  }
